...
s_led_init_timers(uint32_t period)
{
    ...
    tim_init.TIM_Prescaler         = 168; /* One microsecond resolution */
    tim_init.TIM_CounterMode       = TIM_CounterMode_Up;
    tim_init.TIM_Period            = period; /* One-second period */
...
static void
s_led_init_pwm_mode(uint32_t pulse_width)
{
...
{
    s_led_init_timers(1000000);
    s_led_init_pwm_mode(10000);
    s_led_init_led_pins();
...
{
    uint32_t period = 1000000 / 255 / 255;
